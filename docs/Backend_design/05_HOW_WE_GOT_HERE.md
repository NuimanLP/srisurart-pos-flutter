...
> 🔴 **2026-09-08 — ก่อนหยิบ issue ใบแรก:** ticket #4–#37 ทุกใบเขียนบนสมมติฐาน PostgreSQL แต่อาจารย์แจ้งให้ใช้
> **CouchDB** ([ADR-0012](adr/0012-couchdb-replaces-postgres.md) — Proposed) · **ทุกใบ freeze** จนกว่าจะเคาะ
> ตารางว่าใบไหนเก็บ/ทิ้ง/ย้ายไป frontend อยู่ใน [`06_COUCHDB_REVISION.md §6`](06_COUCHDB_REVISION.md)
> เนื้อหาด้านล่างยังถูกในฐานะ "วิธีที่งานถูกแตก" แต่ **รายชื่อ ticket จะเปลี่ยน**
