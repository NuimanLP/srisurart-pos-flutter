...
```jsonc
{
  "receiptNo": "RC01-2569-08-0042",   // รูปแบบใหม่ตาม ADR-0007 (บิลเก่าก่อนขึ้นระบบยังเป็น RC12345678ABCD)
  "total": "1400.00",
  "items": [
...
| **Tenant** | 1 ร้าน |
| **Tenant lifecycle** | สถานะของร้าน `active` / `suspended` / `closed` และผลของแต่ละสถานะ (ADR-0003) |
