...
| **รายงานข้ามร้าน (ของเจ้าของแฟรนไชส์)** | ง่ายสุด (query เดียว) | ต้อง UNION | ยากสุด |
...
> ซึ่งกลายเป็น **ช่องรั่วที่ใหญ่ที่สุดในระบบ ที่เราสร้างขึ้นมาเอง**
> → ต้องเป็น endpoint แยกต่างหาก + เขียน `audit_log` ทุกครั้งที่เรียก ไม่ใช่ path ปกติของแอป
>
