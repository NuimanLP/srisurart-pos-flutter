...
| 400 | `WEAK_PASSWORD` | `รหัสผ่านสั้นเกินไป ต้องมีอย่างน้อย 12 ตัวอักษร` (#364, agent ร่าง — ops เห็นเท่านั้น ไม่ขึ้นที่หน้าร้าน) |
