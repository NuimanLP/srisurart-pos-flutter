...
| op ที่ส่งช้า หลังเครื่องเปิดกะใหม่ไปแล้ว | วัดกับกะ**ใหม่** (กะที่เปิดอยู่ตอน push) → วันที่เก่ากว่า `opened_at − 5 นาที` ถูก clamp + `date_flag` · owner รับรอง 2026-09-25 (ผลเดียวกับที่ §14 ยอมรับ) |
