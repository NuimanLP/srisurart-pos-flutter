...
class ServerErrorResolver {
  ...
  static const Map<String, String> _canonicalMessages = {
    ...
    // #364 — `POST /platform/tenants` refuses an owner password under 12 characters
    // (the same floor `bootstrap:admin` enforces). Ops-facing, not counter-facing:
    ...
    'WEAK_PASSWORD': 'รหัสผ่านสั้นเกินไป ต้องมีอย่างน้อย 12 ตัวอักษร',
